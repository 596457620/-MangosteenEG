...
public class Gloading {
    ...
    public interface Adapter {
         ...
         * @see Holder
         */
        View getView(Holder holder, View convertView, int status, String des);
    }
    ...
    public Holder wrap(Activity activity, String des) {
        ViewGroup wrapper = activity.findViewById(android.R.id.content);
        return new Holder(mAdapter, activity, wrapper, des);
    }
    ...
    public Holder wrap(View view, String des) {
        ...
        return new Holder(mAdapter, view.getContext(), wrapper, des);
    }
    ...
    public static class Holder {
        ...
        private Holder(Adapter adapter, Context context, ViewGroup wrapper, String des) {
        ...
        public void showLoadingStatus(int status) {
            ...
            try {
                ...
                View view = mAdapter.getView(this, convertView, status, des);
                if (view == null) {
